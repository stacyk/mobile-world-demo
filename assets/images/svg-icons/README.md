...
[`wpdemo_get_svg( $args = array() ); // Return SVG markup`](../../blob/master/inc/template-tags.php#L125) 
```
/**
 * Return SVG markup.
 *
...
Example usage:
`<?php echo wpdemo_get_svg( 'twitter'); ?>`
...
```
[`wpdemo_do_svg( $icon_name ); // Echo SVG markup`](../blob/master/inc/template-tags.php#L139)

Example usage: 
`<?php wpdemo_do_svg( 'facebook' ); ?>`
